...
:zephyr_file:`boards/nxp/mr_mcxn_t1/mr_mcxn_t1_mcxn947_cpu0_defconfig`
...
.. code-block:: console
   ...
   *** Booting Zephyr OS build v3.6.0-479-g91faa20c6741 ***
   Hello World! mr_mcxn_t1/mcxn947/cpu0

Building a dual-core image
--------------------------

The dual-core samples are run using ``mr_mcxn_t1/mcxn947/cpu0`` target.

Images built for ``mr_mcxn_t1/mcxn947/cpu1`` will be loaded from flash
