...
this board with new support for Zephyr features.  The mimxrt1170_fmurt7 board
...
``boards/arm/mimxrt1170_fmurt7/mimxrt1170_fmurt7_defconfig``
...
(where the target is ``mimxrt1170_fmurt7_cm4``). For dual core builds, the
